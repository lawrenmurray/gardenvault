...
const WhisperSection = {
    ...
    show() {
        ...
        introMsg.textContent = 'Plant your whispers; the garden will listen.';
        ...
        backBtn.addEventListener('click', () => {
            ...
            if (hasUnsentWhispers) {
                ...
                // Track empty exit
                Guardian.whisper.complete('abandoned', '', 0);
    ...
    showEnvelopeHelp() {
        ...
        text.innerHTML = 'Your whispers gather like morning dew...<br><br>Touch the seed that bloomed to send them skyward,<br>or continue writing until your garden overflows.';
    ...
    showReturnConfirmation(callback) {
        ...
        text.style.cssText = `
            ...
            line-height: 1.6;
        `;
        text.textContent = 'Silence your whispers?';
    ...
    sendWhispers() {
        ...
        // Track successful whisper send
        Guardian.whisper.onConfirmationChoice('yes');
        Guardian.whisper.complete('submitted', allWhispers, whisperCount);
        ...
        setTimeout(() => this.showReceived(), 4500);
    },
    ...
    showReceived() {
        ...
        text.style.cssText = `
            ...
            letter-spacing: 2px;
        `;
        text.textContent = 'Whispers received.';
